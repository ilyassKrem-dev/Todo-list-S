...
export default function Overlay({task , setShow , setAllTasks,allTasks}:any) {
    ...
    return (
        <div className="fixed top-0 left-0 bottom-0 right-0 flex items-center justify-center z-40">
            ...
            className="w-[80%] sm:w-[36%] h-[60%] sm:h-[55%] bg-white text-black flex justify-center flex-col rounded-lg border border-blue-400 items-center p-5 gap-y-5 relative px-8 background">
                ...
                <div className="flex flex-col items-center justify-center gap-y-2">
                    ...
                    <Customcheckbox task={taskDesc} changeHandler={handleChange} bgColor="accent"/>
                </div>
